document.addEventListener("DOMContentLoaded", function() {
    ...
    const helpHint = "Use command help for more info";
    let lineCount = 0;
    ...
    function startAnimation() {
        ...
        setTimeout(() => {
            generateRandomLines(40, showInitializedScreen); // Generate 60 lines
    ...
    function generateRandomLines(lineCount) {
        ...
        // Print lines with random delays and 10% of characters in each line being red
    ...
    function printTextWithRedCharacters(text) {
        ...
        for (let i = 0; i < text.length; i++) {
            if (Math.random() < 0.085) { // 10% chance of character being red
    ...
    setInterval(updateRedCharacters, 50);
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    popup.remove();
                    loadWebsite();
                }, 1000); // Remove the pop-up after 2.5 seconds
